...
function UpdateProfile() {
    ...
    const handleDelete = () => {
        ...
        if (!ConfirmDelete) {
            return toast.success("Welcome for come back!")
        }
        try {
    ...
    const style = 'w-full border-none p-2 rounded font-bold bg-[#7DE5ED] cursor-pointer'
    return (
        <div className='px-6 md:px-0 py-14 bg-sky-100'>
            <div className='flex flex-col-reverse items-center'>
                <div className='w-full mt-10 sm:w-full md:max-w-xl text-center'>
                ...
                <form onSubmit={handleUpdate} className="p-6 md:max-w-xl shadow-xl bg-white rounded-lg">
                    <div>
                        <h2 class="text-lg font-bold text-black capitalize ">Update info </h2>
