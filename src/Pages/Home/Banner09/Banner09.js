...
const Banner09 = () => {
    ...
    return (
        <div className={`topSlider ${pathHome ? 'UniversalPadding py-24 ' : "lg:px-14"} lg:border-l`}>
            <div className={`${!pathHome && 'hidden lg:block'} p-4`}>
                <h2 className='font-diplayFair text-3xl md:text-5xl font-bold'>Blogs
                    <p className='border inline-block border-[#131111] h-[1px] w-16 ml-4 items-end'></p></h2>
